...
class GeminiLLM:
    ...
    def generate(self, prompt: str, system_prompt: Optional[str] = None) -> str:
        ...
        try:
            ...
            # Remove emojis from response (Whitelist approach with expanded characters)
            import re
            # Allow words, whitespace, common punctuation, and currency symbols (Rupee - \u20B9)
            # \w includes Unicode characters (good for Marathi)
